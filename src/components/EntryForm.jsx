...
export default function EntryForm({ entryId }) {
  ...
  let [localContent, setLocalContent] = useState(
    "Write your journal entry here."
  );
  let [localAuthor, setLocalAuthor] = useState(
    "Super Cool Author - that's you!"
  );
  ...
  return (
    <>
      ...
      <button onClick={handleSubmission}>Submit new entry</button>
    </>
  );
}
